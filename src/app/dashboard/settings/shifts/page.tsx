...
import { Shift, ShiftDeletionPreview, ShiftForm, shiftFormSchema } from "@/types/forms";
...
export default function ShiftsPage() {
  ...
  const [deletionPreview, setDeletionPreview] = useState<ShiftDeletionPreview | null>(null);
  ...
  const deleteShift = async (shift: Shift) => {
    await axios.delete(`/api/manager/shifts/${shift.id}`, {
      ...
      data: replacementShiftId ? { replacement_shift_id: Number(replacementShiftId) } : {},
    });
