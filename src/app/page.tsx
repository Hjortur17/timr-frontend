...
const faqs = [
  {
    question: "Er hægt að prófa kerfið frítt?",
    answer:
      "Já, þú getur prófað Timr í 30 daga án þess að gefa upp greiðslukortaupplýsingar. Engin skuldbinding og hægt að hætta hvenær sem er.",
  },
  {
    question: "Hversu marga starfsmenn get ég skráð?",
    answer:
      "Það fer eftir pakkanum sem þú velur. Nettur pakki styður allt að 15 starfsmenn, Þéttur allt að 40, og Allur pakkinn allt að 100. Hafðu samband ef þú þarft fleiri.",
  },
  {
    question: "Er til app fyrir starfsmenn?",
    answer:
      "Já, starfsmannaappið er í boði bæði fyrir iOS og Android. Starfsmenn geta séð vaktir sínar, skráð sig inn og út og fengið tilkynningar um breytingar á vaktarplani.",
  },
  {
    question: "Tekur kerfið tillit til íslenskra kjarasamninga?",
    answer:
      "Já, Timr er hannað sérstaklega fyrir íslenska vinnustaði. Kerfið reiknar sjálfkrafa dagvinnu, yfirvinnu og stórhátíðarkaup í samræmi við íslenska kjarasamninga.",
  },
  {
    question: "Get ég skipt um pakka síðar?",
    answer:
      "Já, þú getur uppfært eða lækkað pakka hvenær sem er. Breytingin tekur gildi strax og verðið er hlutfallslegt miðað við það sem eftir er af greiðslutímabilinu.",
  },
  {
    question: "Hvernig virkar GPS innstimplun?",
    answer:
      "Þegar starfsmaður stempur sig inn staðfestir kerfið að hann sé innan ákveðins GPS-sviðs frá vinnustaðnum. Stjórnandi stillir staðsetningu og leyfilegt svið í stillingum. Ef starfsmaður er utan sviðs er innstimplunin hafnað.",
  },
];
...
const tiers = [
  {
    ...
    description: "Fyrir lítið fyrirtæki sem er að koma sér upp skipulagi á vaktaskipulagi.",
    features: [
  ...
  },
  {
    ...
    description: "Fyrir fyrirtæki í vexti sem þarfnast fleiri stjórnenda og betri yfirsýnar.",
    features: [
  ...
  },
  {
    ...
    description: "Fyrir stærri rekstur með margar starfsstöðvar og flóknari þarfir.",
    features: [
    ...
    <>
          ...
          <div className="flex flex-row items-center gap-12 lg:gap-16">
            ...
            <div className="flex flex-col gap-8 w-7/12">
              ...
              <p className="max-w-lg text-lg leading-relaxed text-muted-foreground lg:text-xl">
                Skipuleggðu vaktir, fylgstu með mætingu og gefðu starfsfólki þínu yfirsýn yfir eigin vinnutíma — allt á
                einum stað. Timr er hannað fyrir fyrirtæki sem vilja einfalda dagleg verkefni og spara tíma.
              </p>
              ...
              <div className="flex flex-col gap-4">
                ...
                <small className="text-muted-foreground text-xs">
                  Prófaðu í 30 daga án þess að gefa upp greiðslukort.
                </small>
              </div>
            </div>
        ...
        <div className="mx-auto max-w-8xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:mx-0">
            ...
            <p className="mt-6 text-lg/8 text-muted-foreground">
              Hvort sem þú ert að stjórna liltu fyrirtæki eða stóru að þá auðveldar Timr þér með umfangið í kringum
              vaktarskipulag.
            </p>
          </div>
        ...
        <div className="mx-auto max-w-8xl px-6 lg:px-8">
          ...
          <form className="mt-20 group/tiers">
            <div className="flex justify-center">
              <fieldset aria-label="Greiðslutíðni">
                <div className="grid grid-cols-2 gap-x-1 rounded-full p-1 text-center text-xs/5 font-semibold ring-1 ring-border">
                  <label className="group relative rounded-full px-2.5 py-1 has-checked:bg-primary">
                    ...
                    />
                    <span className="text-muted-foreground group-has-checked:text-primary-foreground">Mánaðarlegt</span>
                  </label>
                  <label className="group relative rounded-full px-2.5 py-1 has-checked:bg-primary">
                    <input
                      ...
                      className="absolute inset-0 appearance-none rounded-full"
                    />
                    <span className="text-muted-foreground group-has-checked:text-primary-foreground">Árlegt</span>
                  </label>
                </div>
              </fieldset>
            </div>
              ...
              {tiers.map((tier) => (
                ...
                >
                  ...
                  <p className="mt-6 flex items-baseline gap-x-1 group-not-has-[[name=frequency][value=monthly]:checked]/tiers:hidden">
                    <span className="text-4xl font-semibold tracking-tight text-foreground ">{tier.price.monthly}</span>
                    <span className="text-sm/6 font-semibold text-muted-foreground">/mán</span>
                  </p>
                  ...
                  <Link href={tier.href} aria-describedby={tier.id} className="mt-6 block">
                    <Button className="w-full cursor-pointer h-12 text-base">Byrja núna</Button>
                  </Link>
      ...
      <section className="bg-background py-24 sm:py-32" id="faq">
        <div className="mx-auto max-w-3xl px-6 lg:px-8">
          ...
          <p className="mt-2 text-4xl font-semibold tracking-tight text-foreground sm:text-5xl">Algengar spurningar</p>
